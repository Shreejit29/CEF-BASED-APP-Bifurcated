...
def build_model_report(data_path, sheet=0, model_path=None, output_dir="model_report", test_size=0.25, random_state=42, n_estimators=200, slope_weight=1.0):
    ...
    # weight slope before split for consistency with app training
    ...
    summary = {
        ...
        "roc_auc": roc_auc, "average_precision": ap, "slope_weight": float(slope_weight)
    }
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Model performance report for 10-cycle CEF Gradient Boosting with SHAP.")
